...
# Now remove the dangling block at the bottom
trailing_tor = """        // Quick Tor Tab
        OutlinedButton(
          onClick = {
            onNewTab(PrivacyProfile.GHOST, null)
            onDismiss()
...
if trailing_tor in content:
    content = content.replace(trailing_tor, "  }")
else:
    print("trailing not found")
